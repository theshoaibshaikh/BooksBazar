...
<body>
	...
	<div class="total-ads main-grid-border">
					  ...
					  <div id="myTabContent" class="tab-content">
						...
						<ul class="list">
							...
							<?php
								...
								if ($sort_p == "LH")
								{
									$sql = "SELECT * FROM postad where ad_category='Cookery' ORDER BY ad_price ASC";
        ...
        //<!--mail coding-->
								...
								elseif ($sort_p == "HL")
								{
									$sql = "SELECT * FROM postad where ad_category='Cookery' ORDER BY ad_price DESC";
									$result = mysqli_query($conn, $sql);
        ...
        //<!--mail coding-->
								...
								{
									$sql = "SELECT * FROM postad where ad_category='Cookery' ORDER BY TimeStamp DESC";
									$result = mysqli_query($conn, $sql);
