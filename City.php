...
<body>
			...
			<div class="selectregion">
			 ...
			 <!--********************************CITY SELECT CODE HERE ************************************************-->
									 ...
									 &nbsp;&nbsp;&nbsp;&nbsp;
										...
										<hr>
											<select id="basic2" name="Color" class="show-tick form-control" onchange="this.form.submit()" multiple>
	...
	<div class="total-ads main-grid-border">
					  ...
					  <div id="myTabContent" class="tab-content">
						...
						<ul class="list">
							...
							<?php
								...
								$CITY ="";
								if(isset($_GET['Color'])){
								$CITY = $_GET['Color'];  // Storing Selected Value In Variable
								}
								$sort_p="";
								if(isset($_GET["sortp"]))
								{
        ...
        //<!--mail coding-->
								...
								{
									$sql = "SELECT * FROM postad where ad_city='$CITY' ORDER BY TimeStamp DESC";
									$result = mysqli_query($conn, $sql);
