...
<body>
	...
	<div class="total-ads main-grid-border">
					  ...
					  <div id="myTabContent" class="tab-content">
						...
						<ul class="list">
							...
							<?php
								...
								{
									$selected_city = $_GET['sel_city'];  // Storing Selected Value In Variable
									$selected_category=$_GET['sel_cat'];
									$selected_title=$_GET['sel_title'];
								}
								$sort_p="";
								if(isset($_GET["sortp"]))
								{
								...
								if ($sort_p == "LH")
								{
									$sql = "SELECT * FROM postad ORDER BY ad_price ASC";
        ...
        //<!--mail coding-->
								...
								elseif ($sort_p == "HL")
								{
									$sql = "SELECT * FROM postad ORDER BY ad_price DESC";
									$result = mysqli_query($conn, $sql);
        ...
        //<!--mail coding-->
								...
								{
									$sql = "SELECT * FROM postad WHERE (ad_city='$selected_city' AND ad_category='$selected_category' AND ad_title='$selected_title') OR (ad_city='$selected_city' AND ad_title='$selected_title') OR (ad_category='$selected_category' AND ad_title='$selected_title') OR (ad_city='$selected_city' AND ad_category='$selected_category')";
									$result = mysqli_query($conn, $sql);
